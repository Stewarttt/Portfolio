...
namespace {
RegisterTrafficRules<GermanVehicle> cvRules(lanelet::traffic_rules::Germany, Participants::Vehicle);
RegisterTrafficRules<GermanPedestrian> cpRules(lanelet::traffic_rules::Germany, Participants::Pedestrian);
RegisterTrafficRules<GermanBicycle> cbRules(lanelet::traffic_rules::Germany, Participants::Bicycle);
